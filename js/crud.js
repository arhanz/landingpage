...
// export const SERVER_URI = "https://api.flywithzoki.com";
export const SERVER_URI = "http://localhost:3001";
// export const SERVER_URI = "http://192.168.1.15:3001";
...
export const approveSpecificTopupRequest = (id) => {
  ...
  const AuthStr = "Bearer ".concat(token);
  return axios.patch(
    SERVER_URI + ACCEPT_SPECIFIC_TOPUP_REQUEST + id + "/approve",
    {},
    {
      headers: {
        Authorization: AuthStr,
...
export const rejectSpecificTopupRequest = (id) => {
  ...
  const AuthStr = "Bearer ".concat(token);
  return axios.patch(
    SERVER_URI + REJECT_SPECIFIC_TOPUP_REQUEST + id + "/decline",
    {},
    {
      headers: {
        Authorization: AuthStr,
